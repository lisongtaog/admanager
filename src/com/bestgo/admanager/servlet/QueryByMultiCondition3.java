...
@WebServlet(name = "QueryByMultiCondition3", urlPatterns = {"/query_by_multi_condition3"}, asyncSupported = true)
public class QueryByMultiCondition3 extends HttpServlet {
