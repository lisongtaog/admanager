...
@WebServlet(name = "temp_query", urlPatterns = {"/temp_query"}, asyncSupported = true)
public class TempQuery extends BaseHttpServlet {
    ...
    private JsonObject fetchOneAppData(long tagId, String startTime, String endTime, String emptyCampaign,
        ...
        if (countryCheck) {
            webAdCampaignHistoryTable = "web_ad_campaigns_country_history_temp";
        }
        if (admobCheck) {
            ...
            if (countryCheck) {
                webAdCampaignHistoryTable = "web_ad_campaigns_country_history_admob_temp";
            }
        }
