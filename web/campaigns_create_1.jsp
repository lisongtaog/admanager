...
<script>
    ...
    var languageList = ["", "English (US)", "Catalan", "Czech", "Cebuano", "Welsh", "Danish", "German", "Basque", "Spanish", "Spanish (Spain)", "Guarani", "Finnish", "French (France)", "Galician", "Hungarian", "Italian", "Japanese", "Korean", "Norwegian (bokmal)", "Norwegian (nynorsk)", "Dutch", "Frisian", "Polish", "Portuguese (Brazil)", "Portuguese (Portugal)", "Romanian", "Russian", "Slovak","Slovenian", "Swedish", "Thai", "Turkish", "Kurdish (Kurmanji)", "Simplified Chinese (China)", "Traditional Chinese (Hong Kong)", "Traditional Chinese (Taiwan)", "Leet Speak", "Afrikaans", "Albanian", "Armenian", "Azerbaijani", "Belarusian", "Bengali", "Bosnian", "Bulgarian", "Croatian", "Dutch (België)", "English (UK)", "Esperanto", "Estonian", "Faroese", "French (Canada)", "Georgian", "Greek", "Gujarati", "Hindi", "Icelandic", "Indonesian", "Irish", "Javanese", "Kannada", "Kazakh", "Latin", "Latvian", "Lithuanian", "Macedonian", "Malay", "Marathi", "Mongolian", "Nepali", "Punjabi", "Serbian", "Swahili", "Filipino", "Tamil", "Telugu", "Malayalam", "Ukrainian", "Vietnamese", "Khmer", "Tajik", "Arabic", "Hebrew", "Urdu", "Persian", "Pashto", "Sinhala", "Japanese (Kansai)", "English (All)", "Spanish (All)", "French (All)", "Chinese (All)", "Portuguese (All)"];
...
//            标签名_地理位置&语言&出价_创建时间
        ...
        $('#btnCreate').click(function () {
            ...
            if( !$("#selectGendarExplode").prop("checked") && gender.length > 1 ){
