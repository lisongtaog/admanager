            ...
            <div class="modal-body">
                <form id="modify_form" class="form-horizontal" action="#" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="inputBudget" placeholder="预算"
                                   autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="inputBidding" placeholder="竞价"
                                   autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <%--<div class="form-group">--%>
                    <%--<label for="inputTags" class="col-sm-2 control-label">国家</label>--%>
                    <%--<div class="col-sm-10">--%>
                    <%--<input data-role="tagsinput" class="form-control" id="inputCountry" placeholder="国家" autocomplete="off">--%>
                    <%--</div>--%>
                    <%--</div>--%>
                    <div class="form-group">
                        <label for="selectRegion" class="col-sm-2 control-label">国家</label>
                        <div class="col-sm-10">
...
<script type="text/javascript">
    ...
    function init() {
        ...
        regionList.forEach(function (one) {
            $('#selectRegion').append($("<option value='" + one.key + "'>" + one.name + "</option>"));
        });
    }
    ...
    $("#new_campaign_dlg .btn-primary").click(function () {
        ...
        $.post('campaign/update', {
            ...
            bidding: bidding,
            tags: tags,
            selectRegion: selectRegion.join(",")
        }, function (data) {
            if (data && data.ret == 1) {
                $("#new_campaign_dlg").modal("hide");
               // location.reload();
                $('#btnNotExistTagSearch').prop("name", false);
                $('#btnNotExistTagSearch').click();
            } else {
    ...
    $('#btnNotExistTagSearch').click(function () {
        if (this.name == "false") {
            $('#btnNotExistTagSearch').css("background-color", "red");
            this.name = "true";
            $.post('campaign/fetch_not_exist_tag_campaigns', {}, function (data) {
                if (data && data.ret == 1) {
                    $(".table tbody > tr").remove();
                    setData(data.data);
                    bindOp();
    ...
    function bindOp() {
        $(".link_modify").click(function () {
            ...
            var countryCodeString = $(tds.get(16)).text().trim();
