...
<script>
    ...
    $('#btnSearch').click(function () {
        ...
        $.post('country_revenue_spend', {
            ...
            if (data && data.ret == 1) {
                ...
                $('#result_header').html("<tr><th>国家</th><th>总收益</th><th>总花费</th><th>总安装</th><th>CPA</th></tr>");
                data = data.data;
                setData(data);
                bindSortOp();
                var str = "总收益: " + data.total_revenue + "总花费: " + data.total_spend + " 总安装: " + data.total_installed +
                    " CPA: " + data.total_cpa;
    ...
    function setData(data) {
        ...
        for (var i = 0; i < data.array.length; i++) {
            ...
            var tr = $('<tr></tr>');
            var keyset = ["country_name", "revenue", "spend", "installed", "cpa"];
