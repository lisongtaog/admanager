  ...
  <div class="panel panel-default">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td><%=one.get("account_id")%>
        </td>
        <td><%=one.get("short_name")%>
        </td>
        <td><%=one.get("status").toString().equals("1") ? "开启" : "关闭"%>
        </td>
      ...
      <div class="modal-body">
        <form id="modify_form" class="form-horizontal" action="#" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="inputShortName" placeholder="缩写"
                     autocomplete="off">
            </div>
          </div>
          <div class="form-group">
...
<script type="text/javascript">
    ...
    $("#btn_add_new_account").click(function () {
        $("#inputAdAccount").val("");
        $("#inputAdAccount").prop("disabled", false);
        $("#inputShortName").val("");
        $("#inputStatus").val("1");
    ...
    function bindOp() {
        $(".link_modify").click(function () {
            ...
            id = $(tds.get(0)).text().trim();
            var account = $(tds.get(1)).text().trim();
            var shortName = $(tds.get(2)).text().trim();
            var status = $(tds.get(3)).text().trim() == "开启" ? "1" : "2";
            $("#inputAdAccount").val(account);
            $("#inputAdAccount").prop("disabled", true);
