...
function init() {
    ...
    //以下的四个遍历用于动态添加选项
    campaignStatusList.forEach(function (one) {
        $('#selectCampaignStatus').append($("<option>" + one + "</option>"));
    });

    campaignStatusListAdmob.forEach(function (one) {
        $('#selectCampaignStatusAdmob').append($("<option>" + one + "</option>"));
    });
