    ...
    $("#btnQueryNoData").click(function(){
        ...
        $.post('query_one/query_not_has_data', {
            ...
            if(data && data.ret == 1){
                ...
                $('#result_header').html("<tr><th>系列ID</th><th>账户简称</th><th>系列名称</th><th>创建时间</th><th>状态</th><th>预算</th><th>竞价</th><th>总花费</th><th>总安装</th><th>总点击</th><th>CPA</th><th>CTR</span></th><th>CVR</th><th>ROI</th></tr>");
                data = data.data;
                setData(data);
                bindSortOp();
...
function setData(data) {
    ...
    for (var i = 0; i < data.array.length; i++) {
        ...
        var tr = $('<tr></tr>');
        var countryCheck = $('#countryCheck').is(':checked');
        var keyset = ["campaign_id", "short_name", "campaign_name", "create_time",
