...
<script>
    ...
    var languageList = ["null", "Albanian","Amharic","Arabic","Armenian","Azerbaijani","Bengali","Bosnian","Bulgarian","Burmese","Catalan","Chinese","Croatian","Czech","Danish","Dutch","English","Estonian","Finnish","Filipino","French","German","Georgian","Greek","Hungarian", "Hindi","Hebrew","Icelandic","Indonesian","Italian","Japanese","Korean","Kyrgyz","Lao","Latvian","Lithuanian","Luxembourgish","Macedonian","Malay","Mongolian","Nepali","Pashto","Polish","Portuguese","Romanian","Russian","Samoan","Serbian","Sinhala","Slovak","Slovenian", "Somali","Spanish","Swahili","Swedish","Tajik","Thai","Norwegian","Traditional","Turkish","Ukrainian","Urdu","Uzbek","Vietnamese"];
