...
<div class="container-fluid">
    <ul class="nav nav-pills">
        ...
        <li role="presentation" class="active"><a href="#">广告存储</a></li>
    </ul>
...
<script>
    ...
    var languageList = ["null", "Albanian","Amharic","Arabic","Armenian","Bengali","Bosnian","Burmese","English","Filipino","French","Georgian",
        "Hindi","Indonesian","Kyrgyz","Lao","Mongolian","Nepali language","Pashto","Portuguese","Samoan","Sinhala",
        "Somali","Spanish","Swahili","Tajik","Ukrainian","Urdu","Uzbek","Vietnamese"];
    var admobLanguageCodes = [{'name': 'All', code: ''},{'name':'Albanian', code:1019},{'name':'Amharic', code:1020},{'name':'Arabic', code:1021},{'name':'Armenian', code:1022},{'name':'Bengali', code:1023},{'name':'Bosnian', code:1024},{'name':'Burmese', code:1025},{'name':'English', code:1026},{'name':'Filipino', code:1027},{'name':'French', code:1028},{'name':'Georgian', code:1029},{'name':'Hindi', code:1030},{'name':'Indonesian', code:1031},{'name':'Kyrgyz', code:1032},{'name':'Lao', code:1033},{'name':'Mongolian', code:1034},{'name':'Nepali language', code:1035},{'name':'Pashto', code:1036},{'name':'Portuguese', code:1037},{'name':'Polish', code:1038},{'name':'Samoan', code:1039},{'name':'Sinhala', code:1040},{'name':'Somali', code:1041},{'name':'Serbian', code:1042},{'name':'Slovak', code:1043},{'name':'Slovenian', code:1044},{'name':'Spanish', code:1045},{'name':'Swedish', code:1046},{'name':'Romanian', code:1047},{'name':'Russian', code:1048},{'name':'Swahili', code:1049},{'name':'Tajik', code:1050},{'name':'Thai', code:1051},{'name':'Turkish', code:1052},{'name':'Ukrainian', code:1053},{'name':'Uzbek', code:1054},{'name':'Ukrainian', code:1055},{'name':'Urdu', code:1056},{'name':'Vietnamese', code:1057}];
    ...
    function init() {
        ...
        admobLanguageCodes.forEach(function(one) {
            $('#selectLanguageAdmob').append($("<option value='" + one.name + "'>" + one.name + "</option>"));
        });
    ...
    $('#selectApp,#selectLanguage').change(function () {
        ...
        if(language != null &&  language.length > 0){
            $.post("advert/queryBeforeInsertion", {
                appName: appName,
                language: language
            }, function (data) {
                if (data && data.ret == 1) {
